...
def get_zabbix_client() -> ZabbixAPI:
    ...
    if zabbix_api is None:
        ...
        # Initialize client with version check skipped for compatibility with older versions
        zabbix_api = ZabbixAPI(url=url, validate_certs=verify_ssl, skip_version_check=True)
